package org.dtsolutions.blog.security;
...
import static org.dtsolutions.blog.security.SecurityConstants.*;
    ...
    public Authentication attemptAuthentication(final HttpServletRequest request,
        ...
        try {
            ...
            final SecurityUser securityUser
                    = new SecurityUser(credentials.getUsername(), credentials.getPassword(), new ArrayList<>());
